            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color ">
                  Bienvenu à Positiv action Lorem....
                </p>
                <p className="flex items-center text-sm font-medium text-dark ">
                  ...
                  <span>+229 34 56 78 99</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Faisons connaissance">
              <NavLink link="/#" label="Histoires" />
              <NavLink link="/#" label="Missions" />
              <NavLink link="/#" label="Partenaires" />
              <NavLink link="/#" label="Apaciens" />
            </LinkGroup>
            <LinkGroup header="nos programmes">
              <NavLink link="/#" label="Webinaires" />
              <NavLink link="/#" label="Newletters" />
              <NavLink link="/#" label="Podcast" />
              <NavLink link="/#" label="Revue Africain" />
            </LinkGroup>
            <LinkGroup header="nous soutenir">
              <NavLink link="/#" label="Faire un don" />
              <NavLink link="/#" label="Deveni Partenaires" />
              <NavLink link="/#" label="Nous rejoindre" />
            </LinkGroup>
