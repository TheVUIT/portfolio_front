...
const Video = () => {
  ...
  return (
    ...
    <section className="mx-auto flex w-full border-solid border-2 border-red-400 bg-white py-20 dark:bg-dark lg:py-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-10/12">
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              ...
              <div
                className={`absolute left-0 top-0 z-10 flex h-full w-full items-center justify-center bg-blue-300 bg-opacity-90`}
              >
                <a
                  href="/#"
          ...
          <div className="mx-auto w-full max-w-[550px] bg-white">
            <>
              <iframe
                ...
                src="https://www.youtube.com/embed/MVuxchUqN_s?list=RDEMq66emDyW4424xMFtE3At7w"
              />
            </>
          </div>
