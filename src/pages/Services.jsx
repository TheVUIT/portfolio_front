...
const Services = () => {
  return (
    <main className='w-screen pt-28 flex flex-col items-start justify-center bg-background_primary lg:bg-backgroung_secondary lg:pt-32'>
      ...
      <section className='w-full flex flex-col lg:flex-row '>
        <div className='w-auto flex flex-col items-center'>
          <div className='h-auto w-auto p-3 bg-texte_secondary text-backgroung_secondary font-ubuntu text-5xl rounded-2xl'>
            24 PNG 4K

          </div>
          <p className='font-ubuntu text-sm font-semibold'>
            4096px X 4096px
          </p>
        </div>
