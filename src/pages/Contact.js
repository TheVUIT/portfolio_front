...
function Contact() {
  ...
  <div class="bg-white max-w-4xl mx-auto w-full">
    <div class="grid grid-cols-6 h-full">
      <div class="bg-blue-700 p-10 col-span-2">
      ...
      <div class="bg-blue-50 p-14 col-span-4">
        ...
        <div class="flex justify-center">
          <button class="rounded-full bg-blue-700 text-white font-bold py-4 px-6 min-w-40 hover:bg-blue-800 transition-all">Valider</button>
        </div>
      </div>
    </div>
  </div>
